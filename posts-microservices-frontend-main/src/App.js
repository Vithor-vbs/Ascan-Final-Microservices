...
function App() {
    ...
    return (
        <div className="App container">
            <form className="row headers" onSubmit={createPost}>
                <div className="col-4">
                    <h2>Cart Administrator</h2>

                    <input className="form-control mb-3" placeholder="Enter your email" onChange={e => title = e.target.value}/>
